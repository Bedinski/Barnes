...
import * as worldMap      from './scenes/worldMap.js?v=7';
...
import * as buildSentence from './scenes/buildSentence.js?v=7';
...
import { mountSvgFilters } from './components/svgFilters.js?v=7';
import { hasBuddy }        from './components/buddy.js?v=7';
